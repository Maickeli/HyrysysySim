...
public class CameraFollow : MonoBehaviour
{
    ...
    public VehicleController vehicleController; // Car
    ...
    void LateUpdate()
    {
        ...
        usedDistance = Mathf.SmoothDampAngle(usedDistance, distance + (vehicleController.GetVelocityMagnitude() * distanceMultiplier), ref zVelocity, distanceSnapTime);
